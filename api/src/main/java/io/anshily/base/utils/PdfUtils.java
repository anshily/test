...
public class PdfUtils {
	...
	public static void main(String[] args) {
		try {
			...
			o.put("name", "1http://www.xdemo.org/景清华");
			String path = PdfHelper.getPath();
			@SuppressWarnings("unused")
			String html = PdfHelper.getPdfContent(path, "resources/tpl1.ftl", o);
			generateToFile(path, "resources/tpl1.ftl", path + "resources/", o, "D:\\xdemo.pdf");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void generateToFile(String ftlPath, String ftlName, String imageDiskPath, Object data,
		...
		System.out.println(imageDiskPath);
