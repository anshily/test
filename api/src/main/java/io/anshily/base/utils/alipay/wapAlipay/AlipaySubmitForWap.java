...
import io.anshily.base.utils.alipay.sign.MD5;
import io.anshily.base.utils.alipay.sign.RSA;
import io.anshily.base.utils.alipay.util.httpClient.HttpProtocolHandler;
import io.anshily.base.utils.alipay.util.httpClient.HttpRequest;
import io.anshily.base.utils.alipay.util.httpClient.HttpResponse;
import io.anshily.base.utils.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmitForWap {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
		String prestr = AlipayCoreForWAP.createLinkString(sPara); //把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串
		String mysign = "";
		if (AlipayConfigForWap.sign_type.equals("MD5")) {
			mysign = MD5.sign(prestr, AlipayConfigForWap.key, AlipayConfigForWap.input_charset);
		}
		if (AlipayConfigForWap.sign_type.equals("0001")) {
			mysign = RSA.sign(prestr, AlipayConfigForWap.private_key, AlipayConfigForWap.input_charset);
		}
		return mysign;
	}
	...
	public static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
		//除去数组中的空值和签名参数
		Map<String, String> sPara = AlipayCoreForWAP.paraFilter(sParaTemp);
		//生成签名结果
		...
		if (!sPara.get("service").equals("alipay.wap.trade.create.direct")
			...
			sPara.put("sign_type", AlipayConfigForWap.sign_type);
		}
	...
	public static String buildRequest(String ALIPAY_GATEWAY_NEW, Map<String, String> sParaTemp, String strMethod,
		...
		sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + ALIPAY_GATEWAY_NEW
				+ "_input_charset=" + AlipayConfigForWap.input_charset + "\" method=\"" + strMethod + "\">");
	...
	public static String buildRequest(String ALIPAY_GATEWAY_NEW, Map<String, String> sParaTemp, String strMethod,
		...
		sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\"  enctype=\"multipart/form-data\" action=\""
				+ ALIPAY_GATEWAY_NEW + "_input_charset=" + AlipayConfigForWap.input_charset + "\" method=\"" + strMethod
				+ "\">");
	...
	public static String buildRequest(String ALIPAY_GATEWAY_NEW, String strParaFileName, String strFilePath,
		...
		//设置编码集
		request.setCharset(AlipayConfigForWap.input_charset);

		request.setParameters(generatNameValuePair(sPara));
		request.setUrl(ALIPAY_GATEWAY_NEW + "_input_charset=" + AlipayConfigForWap.input_charset);
	...
	public static String getRequestToken(String text) throws Exception {
		...
		if (paraText.get("res_data") != null) {
			...
			if (AlipayConfigForWap.sign_type.equals("0001")) {
				res_data = RSA.decrypt(res_data, AlipayConfigForWap.private_key, AlipayConfigForWap.input_charset);
			}
