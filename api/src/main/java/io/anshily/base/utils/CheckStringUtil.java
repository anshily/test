...
public class CheckStringUtil {
	 ...
	 * @return 16进制字符串
	 */
	//	public staticByhang String ChineseStringToAscii(String s)
	//	{
	//		try
	//		{
	 ...
	 * @return 16进制字符串
	 */
	//	public staticByhang String ChineseStringToUTF(String s)
	//	{
	//		try
	//		{
	 ...
	 * @return 汉字
	 */
	//	public staticByhang String AsciiToChineseString(String s)
	//	{
	...
	//	 */
	//	public staticByhang synchronized String regexReplace(String regularExpression, String sub, String input)
	//	{
	 ...
	 */
	//	//正则表达式匹配判断
	//	public staticByhang synchronized boolean exist(String regularExpression, String input)
	//	{
	//		Pattern pattern = PatternFactory.getPattern(regularExpression);
	//		Matcher matcher = pattern.matcher(input);
	//		return matcher.find();
	...
	public static String getFillString(String strIn, int totalLength, boolean isRightAlign) {
		...
		spaces = CheckStringUtil.getStrSpace(spaceLength);
	...
	/*
	public staticByhang String toHtml(String s)
	{
		//显示
		s = Replace(s, "&", "&amp;");
		s = Replace(s, "\\", "&#92;");
	...
	public staticByhang String unHtml(String s)
	{
		s = Replace(s, "&lt;", "<");
		s = Replace(s, "&gt;", ">");
		s = Replace(s, "    ", "\t");
	...
	*/
	...
	private static CheckStringUtil instance = null;

	public static synchronized CheckStringUtil getInstance() {
		if (instance == null) {
			instance = new CheckStringUtil();
		}
		return instance;
	}
	...
	//	public staticByhang void main(String[] args)
	//	{
	...
	*/
	...
	public static void main(String[] args) {
		...
		String aa = "http://localhost:8081/manage/mm/si.do?in=add";
		CheckStringUtil.filterContent(aa);
	}
