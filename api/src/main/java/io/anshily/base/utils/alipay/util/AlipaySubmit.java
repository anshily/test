package io.anshily.base.utils.alipay.util;

import io.anshily.base.utils.alipay.config.AlipayConfig;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
		...
		if (AlipayConfig.sign_type.equals("MD5")) {
			...
			mysign = RSA.sign(prestr, AlipayConfig.rsa_private_key, AlipayConfig.input_charset);
		}
		return mysign;
	}
