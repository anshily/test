 ...
 * Collections工具�?
 * 
 * 在JDK的Collections和Guava的Collections2�? 命名为Collections3.
 * 
...
public class Collections3 {
	...
	/**
	 * 提取集合中的对象的两个属性通过Getter函数), 组合成Map.
	 * 
	 * @param collection
	 *            来源集合.
	...
	/**
	 * 提取集合中的对象的一个属性通过Getter函数), 组合成List.
	 * 
	 * @param collection
	 *            来源集合.
	 * @param propertyName
	...
	/**
	 * 提取集合中的对象的一个属性通过Getter函数), 组合成由分割符分隔的字符�?
	 * 
	 * @param collection
	 *            来源集合.
	 * @param propertyName
	...
	/**
	 * 转换Collection�?��元素(通过toString())为String,
