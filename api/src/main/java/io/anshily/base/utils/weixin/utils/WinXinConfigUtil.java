...
//	public final staticByhang String BASE_URL = "http://www.huozhuhui.com/";
	public final static String BASE_URL = "http://q.hnqingyun.com/";

	 //微信支付成功回调
	 public final static String WX_PAY_NOTIFY_URL = BASE_URL + "wyhy/api/user/wx_notify";
